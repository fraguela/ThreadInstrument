...
///
/// \file     ThreadInstrument.0.cpp
/// \brief    Library implementation
/// \author   Basilio B. Fraguela <basilio.fraguela@udc.es>
///

/*
 This is an initial version that relied on a standard std::unordered_map<std::thread::id, IdentifiedEventData>
 protected by a lock. It was quite slower than the current implementation according to tests/bench.cpp
*/
...
namespace {
  ...
  typedef std::unordered_map<std::thread::id, IdentifiedEventData> Thr2Ev_t;
